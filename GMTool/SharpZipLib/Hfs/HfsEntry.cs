...
namespace ICSharpCode.SharpZipLib.Hfs
{
    ...
    public enum HostSystemID
    {
        ...
        OSX = 19,
        /// <summary>
        /// Host system = WinHfs AES
        /// </summary>
        WinHfsAES = 99,
    }

    /// <summary>
    /// This class represents an entry in a Hfs archive.  This can be a file
    /// or a directory
    /// HfsFile and HfsInputStream will give you instances of this class as 
    /// information about the members in an archive.  HfsOutputStream
    /// uses an instance of this class when creating an entry in a Hfs file.
    /// <br/>
    /// <br/>Author of the original java version : Jochen Hoenicke
    /// </summary>
    public class HfsEntry : ICloneable
    {
        [Flags]
        enum Known : byte
        {
        ...
        #region Constructors
        /// <summary>
        /// Creates a Hfs entry with the given name.
        /// </summary>
        /// <param name="name">
        ...
        /// </exception>
        public HfsEntry(string name)
            : this(name, 0, HfsConstants.VersionMadeBy, CompressionMethod.Stored)
        {
        }

        /// <summary>
        /// Creates a Hfs entry with the given name and version required to extract
        /// </summary>
        /// <param name="name">
        /// The name for this entry. Can include directory components.
        ...
        /// The name passed is null
        /// </exception>
        internal HfsEntry(string name, int versionRequiredToExtract)
            : this(name, versionRequiredToExtract, HfsConstants.VersionMadeBy,
        ...
        /// <param name="versionRequiredToExtract">Minimum required Hfs feature version required to extract this entry</param>
        ...
        /// </exception>
        /// <remarks>
        /// This constructor is used by the HfsFile class when reading from the central header
        /// It is not generally useful, use the constructor specifying the name only.
        /// </remarks>
        internal HfsEntry(string name, int versionRequiredToExtract, int madeByInfo,
        ...
        /// <summary>
        /// Creates a deep copy of the given Hfs entry.
        /// </summary>
        /// <param name="entry">
        /// The entry to copy.
        /// </param>
        ...
        /// <summary>
        /// Get minimum Hfs feature version required to extract this entry
        /// </summary>		
        public int Version
        {
            get
            {
                return HfsConstants.VersionMadeBy;
            }
        }
        ...
        /// and uncompressed size are were not able to be written during Hfs file creation
        /// The correct values are held in a data descriptor immediately following the compressed data. <br/>
        /// Bit 4: Reserved for use by PKHfs for enhanced deflating<br/>
        ...
        /// <summary>
        /// Get/Set index of this entry in Hfs file
        /// </summary>
        /// <remarks>This is only valid when the entry is part of a <see cref="HfsFile"></see></remarks>
        public long HfsFileIndex
        {
            get
            {
                return hfsFileIndex;
        ...
        /// <summary>
        /// Test the external attributes for this <see cref="HfsEntry"/> to
        ...
        /// by PKHfs for DOS version 2.04g then this value will be zero.  Otherwise the value
        /// will be non-zero and identify the host system on which the attributes are compatible.
        /// </summary>
        /// 		
        /// <remarks>
        /// The values for this as defined in the Hfs File format and by others are shown below.  The values are somewhat
        /// misleading in some cases as they are not all used as shown.  You should consult the relevant documentation
        /// to obtain up to date and correct information.  The modified appnote by the infoHfs group is
        ...
        /// See the <see cref="HfsNameTransform"/> class, or <see cref="CleanName(string)"/>
        ///</remarks>
        public string Name
        {
            get
        ...
        /// avoid compatability problems with some archivers which dont understand Hfs64 extensions.</remarks>
        public long Size
        {
            get
            {
        ...
        /// </returns>
        /// <remarks>
        /// A comment is only available for entries when read via the <see cref="HfsFile"/> class.
        ...
        /// <summary>
        /// Gets a string representation of this HfsEntry.
        /// </summary>
        /// <returns>A readable textual representation of this <see cref="HfsEntry"/></returns>
        ...
        /// <summary>
        /// Cleans a name making it conform to Hfs file conventions.
        /// Devices names ('c:\') and UNC share names ('\\server\share') are removed
        /// and forward slashes ('\') are converted to back slashes ('/').
        /// Names are made relative by trimming leading slashes which is compatible
        /// with the Hfs naming convention.
        /// </summary>
        /// <param name="name">The name to clean</param>
        /// <returns>The 'cleaned' name.</returns>
        /// <remarks>
        /// The <seealso cref="HfsNameTransform">Hfs name transform</seealso> class is more flexible.
        /// </remarks>
        ...
        long hfsFileIndex = -1;                // used by HfsFile
        long offset;                           // used by HfsFile and HfsOutputStream
        #endregion
    }
}
